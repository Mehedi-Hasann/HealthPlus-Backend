...
router.get('/orders/:id',auth(Role.CUSTOMER,Role.ADMIN,Role.SELLER),customerController.getSingleOrder);
...
router.put('/profile',auth(Role.CUSTOMER,Role.ADMIN ,Role.SELLER),customerController.editMyProfile);
...
router.post('/address',validateRequest(createAddressZodSchema),auth(Role.CUSTOMER,Role.ADMIN,Role.SELLER),customerController.createAddress);
router.put('/update-my-address',auth(Role.CUSTOMER,Role.SELLER,Role.ADMIN),customerController.updateAddress);
...
router.get('/my-address',auth(Role.CUSTOMER,Role.ADMIN,Role.SELLER),customerController.getMyAddress);
